...
const getSlideVariants = (direction: DrawerDirection): Variants => ({
    hidden: {
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className={`fixed top-0 bottom-0 z-50 flex flex-col bg-surface shadow-2xl outline-none ${direction === 'left' ? 'left-0 border-r' : 'right-0 border-l'} border-border ${sizeClasses[size]} ${className}`}
                        role="dialog"
                        aria-modal="true"
