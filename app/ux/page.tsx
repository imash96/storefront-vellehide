...
import { ChevronDown, Menu, Grid, LayoutGrid, Eye, MousePointer, Layers, Zap, Shield } from 'lucide-react';
...
export default function UXArchitecture() {
  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      {/* Header */}
      <header className="border-b border-border sticky top-0 bg-surface-overlay backdrop-blur z-50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-light tracking-tight">UX Architecture</h1>
              <p className="text-sm text-on-surface-tertiary mt-1">Premium Leather Clothing Brand</p>
            </div>
            <div className="flex gap-2">
              <span className="px-3 py-1 accent-surface text-accent text-xs rounded-full border">
                Next.js 16+
              </span>
              <span className="px-3 py-1 info-surface text-info text-xs rounded-full border" style={{ backgroundColor: 'rgba(37, 99, 235, 0.1)', borderColor: 'rgba(37, 99, 235, 0.2)' }}>
                Tailwind 4+
              </span>
              <span className="px-3 py-1 secondary-surface text-secondary text-xs rounded-full border">
                Medusa v2.13
              </span>
            </div>
          </div>
      ...
      <div className="flex">
        {/* Sidebar Navigation */}
        <aside className="w-64 border-r border-border min-h-screen sticky top-18.25 self-start hidden lg:block">
          <nav className="p-6">
            {sections.map((section) => (
              <button
                key={section.id}
                onClick={() => setActiveSection(section.id)}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-all mb-2 ${activeSection === section.id
                  ? 'bg-surface-elevated-high text-on-surface'
                  : 'text-on-surface-secondary hover-surface hover:text-on-surface'
                  }`}
              >
        ...
        <main className="flex-1 p-8 max-w-5xl">
          ...
          {activeSection === 'layout' && <LayoutSection activeLayout={activeLayout} setActiveLayout={setActiveLayout} />}
...
function OverviewSection() {
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">UX Architecture Overview</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed mb-8">
      ...
      <div className="mt-12 p-8 bg-surface-elevated rounded-2xl border border-border">
...
function LayoutSection({ activeLayout, setActiveLayout }: LayoutSectionProps) {
  const layouts = [
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">Layout System</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
          Flexible grid system with editorial focus, supporting asymmetric layouts and generous spacing.
        </p>
      </div>
...
function ComponentsSection() {
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">Component Hierarchy</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
          Modular component architecture organized by complexity and reusability.
        </p>
      </div>
...
function NavigationSection() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">Navigation Patterns</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
          Multi-level navigation system optimized for product discovery and conversion.
        </p>
      </div>
...
function InteractionsSection() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">Interaction Patterns</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
...
function TemplatesSection() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">Page Templates</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
          Comprehensive page structures optimized for conversion and user experience.
        </p>
      </div>
...
function MetricsSection() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-4xl font-light tracking-tight mb-6">UX Metrics & Goals</h2>
        <p className="text-on-surface-secondary text-lg leading-relaxed">
          Key performance indicators and targets for measuring user experience quality.
        </p>
      </div>
...
function PrincipleCard({ title, description, color }: PrincipleCardProps) {
  const colorClasses = {
    ...
    neutral: 'bg-surface-elevated-high text-on-surface border-border'
  };

  return (
    <div className={`p-6 rounded-xl border ${colorClasses[color]}`}>
      <h3 className="text-lg font-light mb-3">{title}</h3>
      <p className="text-sm text-on-surface-secondary leading-relaxed">{description}</p>
    </div>
  );
}
...
function FeatureItem({ label, description }: FeatureItemProps) {
  return (
    <div className="flex gap-4 items-start">
      ...
      <div>
        <div className="text-on-surface font-light">{label}</div>
        <div className="text-sm text-on-surface-tertiary mt-1">{description}</div>
      </div>
    </div>
  );
}
