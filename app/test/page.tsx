...
import {
  Star, Heart, ShoppingCart, Check, X, AlertCircle, Info, ChevronRight,
  Search, Menu, User, Package, Truck, CreditCard, Eye, Trash2,
  Plus, Minus, Filter, ArrowUpDown, Grid, List, MapPin, Phone, Mail
} from 'lucide-react';
